...
<div class="sidebar">
    ...
    <nav class="sidebar-menu">
        <a href="${pageContext.request.contextPath}/manager/dashboard" class="active"> Dashboard</a>
        ...
        <a href="${pageContext.request.contextPath}/manager/help"> Help</a>
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="topbar-user">
            ...
            <span class="user-badge" style="background:#e74c3c;">Manager</span>
        </div>
    </div>
    <div class="page-content">
        ...
        <div class="card">
            ...
            <a href="${pageContext.request.contextPath}/manager/reservation?action=add" class="btn btn-primary"> New Reservation</a>&nbsp;
            <a href="${pageContext.request.contextPath}/manager/reservation?action=view" class="btn btn-success"> Search</a>&nbsp;
            <a href="${pageContext.request.contextPath}/manager/staff" class="btn btn-warning"> Manage Staff</a>&nbsp;
            <a href="${pageContext.request.contextPath}/manager/report" class="btn btn-danger"> Monthly Report</a>
        </div>
        <div class="card">
